...
/**
 * Compare the <b>names</b> of two files for order (see {@link AbstractFile#getName()}).
 * <p>
 ...
 */
public class NameFileComparator implements Comparator<AbstractFile>, Serializable {
    /** Case-sensitive name comparator instance (see {@link IOCase#SENSITIVE}) */
    public static final Comparator<AbstractFile> NAME_COMPARATOR = new NameFileComparator();
    /** Reverse case-sensitive name comparator instance (see {@link IOCase#SENSITIVE}) */
    public static final Comparator<AbstractFile> NAME_REVERSE = new ReverseComparator<AbstractFile>(NAME_COMPARATOR);
    /** Case-insensitive name comparator instance (see {@link IOCase#INSENSITIVE}) */
    public static final Comparator<AbstractFile> NAME_INSENSITIVE_COMPARATOR = new NameFileComparator(IOCase.INSENSITIVE);
    /** Reverse case-insensitive name comparator instance (see {@link IOCase#INSENSITIVE}) */
    public static final Comparator<AbstractFile> NAME_INSENSITIVE_REVERSE = new ReverseComparator<AbstractFile>(NAME_INSENSITIVE_COMPARATOR);
    /** System sensitive name comparator instance (see {@link IOCase#SYSTEM}) */
    public static final Comparator<AbstractFile> NAME_SYSTEM_COMPARATOR = new NameFileComparator(IOCase.SYSTEM);
    /** Reverse system sensitive name comparator instance (see {@link IOCase#SYSTEM}) */
    public static final Comparator<AbstractFile> NAME_SYSTEM_REVERSE = new ReverseComparator<AbstractFile>(NAME_SYSTEM_COMPARATOR);
