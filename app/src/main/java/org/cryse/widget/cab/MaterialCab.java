...
public class MaterialCab implements Serializable, Toolbar.OnMenuItemClickListener {
    ...
    public MaterialCab(@NonNull AppCompatActivity context, View attacherParent, @IdRes int attacherId) {
        mContext = context;
        mAttacherParent = attacherParent;
    ...
    private boolean attach() {
        final View attacher = mAttacherParent.findViewById(mAttacherId);
        if (mAttacherParent.findViewById(R.id.mcab_toolbar) != null) {
            mToolbar = (Toolbar) mAttacherParent.findViewById(R.id.mcab_toolbar);
