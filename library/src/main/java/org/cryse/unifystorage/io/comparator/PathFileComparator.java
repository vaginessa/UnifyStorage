...
/**
 * Compare the <b>path</b> of two files for order (see {@link AbstractFile#getPath()}).
 * <p>
 ...
 */
public class PathFileComparator implements Comparator<AbstractFile>, Serializable {
    /** Case-sensitive path comparator instance (see {@link IOCase#SENSITIVE}) */
    public static final Comparator<AbstractFile> PATH_COMPARATOR = new PathFileComparator();
    /** Reverse case-sensitive path comparator instance (see {@link IOCase#SENSITIVE}) */
    public static final Comparator<AbstractFile> PATH_REVERSE = new ReverseComparator<AbstractFile>(PATH_COMPARATOR);
    /** Case-insensitive path comparator instance (see {@link IOCase#INSENSITIVE}) */
    public static final Comparator<AbstractFile> PATH_INSENSITIVE_COMPARATOR = new PathFileComparator(IOCase.INSENSITIVE);
    /** Reverse case-insensitive path comparator instance (see {@link IOCase#INSENSITIVE}) */
    public static final Comparator<AbstractFile> PATH_INSENSITIVE_REVERSE = new ReverseComparator<AbstractFile>(PATH_INSENSITIVE_COMPARATOR);
    /** System sensitive path comparator instance (see {@link IOCase#SYSTEM}) */
    public static final Comparator<AbstractFile> PATH_SYSTEM_COMPARATOR = new PathFileComparator(IOCase.SYSTEM);
    /** Reverse system sensitive path comparator instance (see {@link IOCase#SYSTEM}) */
    public static final Comparator<AbstractFile> PATH_SYSTEM_REVERSE = new ReverseComparator<AbstractFile>(PATH_SYSTEM_COMPARATOR);
