...
public class SuperRecyclerView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            mSuperRecyclerViewMainLayout = a.getResourceId(R.styleable.superrecyclerview_mainLayoutId, R.layout.widget_srv);
            ...
            mProgressId = a.getResourceId(R.styleable.superrecyclerview_layout_progress, R.layout.widget_srv_progress);
        } finally {
            a.recycle();
        }
    }
    ...
    private void initView() {
        ...
        if(mOnMoreListener != null)
            mOnMoreListener.onChangeMoreVisibility(View.GONE);
    ...
    private void processOnMore() {
        ...
        if (((totalItemCount - lastVisibleItemPosition) <= ITEM_LEFT_TO_LOAD_MORE ||
            ...
            isLoadingMore = true;
            if (mOnMoreListener != null) {
                mOnMoreListener.onChangeMoreVisibility(View.VISIBLE);
     ...
     */
    private void setAdapterInternal(final RecyclerView.Adapter adapter, boolean compatibleWithPrevious,
