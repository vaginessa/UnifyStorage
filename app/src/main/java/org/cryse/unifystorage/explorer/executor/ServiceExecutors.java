 ...
 */
/* package */ public final class ServiceExecutors {

    private static final ServiceExecutors INSTANCE = new ServiceExecutors();
     ...
     * the stack runs too deep, at which point it will delegate to {@link ServiceExecutors#background}
        ...
        public void execute(Runnable command) {
            ...
            try {
                if (depth <= MAX_DEPTH) {
                    ...
                    ServiceExecutors.background().execute(command);
                }
            } finally {
                decrementDepth();
            }
